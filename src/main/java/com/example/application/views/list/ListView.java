...
public class ListView extends VerticalLayout {
    ...
    private void configureListBox(){
        ...
        //come vado alla view con le info sull'utente? appena provo a passare parametri non va più nulla
        //show.addValueChangeListener(e->show.getUI().ifPresent(ui->ui.navigate(InfoUtente.class)));
        show.addValueChangeListener(e->show.getUI().ifPresent(ui->ui.navigate(InfoUtente.class,new RouteParameters("parametro",e.getValue().toString()))));
